...
private struct ProviderSidebarRowView: View {
    ...
    var body: some View {
        ...
        HStack(alignment: .center, spacing: 10) {
            ProviderSidebarReorderHandle()
                ...
                .help(AppStrings.tr("Drag to reorder"))
                .onDrag {
    ...
    private var statusText: String {
        ...
        if lines.count >= 2 {
            ...
            return AppStrings.fmt("Disabled — %@", "\(first)\n\(rest)")
        }
        return AppStrings.fmt("Disabled — %@", self.subtitle)
    }
}
...
private struct ProviderSidebarReorderHandle: View {
    var body: some View {
        ...
        .accessibilityLabel(AppStrings.tr("Reorder"))
    }
}
