...
func showAbout() {
    ...
    let credits = NSMutableAttributedString(string: "CodexBar contributors — MIT License\n")
    credits.append(makeLink("GitHub", urlString: "https://github.com/steipete/CodexBar"))
    credits.append(separator)
    credits.append(makeLink("Docs", urlString: "https://github.com/steipete/CodexBar#readme"))
