...
extension SettingsStore {
    ...
    func applyProviderDetection() async {
        ...
        let antigravityHasTokens = AntigravityOAuthStorage().hasTokens()
        ...
        logger.info(
            ...
            metadata: [
                ...
                "antigravityHasTokens": antigravityHasTokens ? "1" : "0",
            ])
        logger.info(
