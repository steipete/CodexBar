...
struct QwenCloudCookieHeaders {
    private static let cachedAPIHeaderName = "__codexbar_qwen_cloud_api"
    private static let cachedDashboardHeaderName = "__codexbar_qwen_cloud_dashboard"
