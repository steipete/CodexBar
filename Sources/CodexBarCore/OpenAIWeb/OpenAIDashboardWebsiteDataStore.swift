...
public enum OpenAIDashboardWebsiteDataStore {
    ...
    public static func store(
        ...
        workspaceLabel: String? = nil) -> WKWebsiteDataStore
    {
        guard let normalized = normalizeAccountKey(
            email: email,
        ...
        workspaceLabel: String? = nil) async
    {
        ...
        if let normalized = normalizeAccountKey(
            email: email,
            workspaceAccountID: workspaceAccountID,
            workspaceLabel: workspaceLabel)
        {
    ...
    private static func normalizeAccountKey(
        email: String?,
