...
public struct UsageSnapshot: Codable, Sendable {
    ...
    public let clinePassUsage: ClinePassUsageSnapshot?
    ...
    public init(
        ...
        clinePassUsage: ClinePassUsageSnapshot? = nil,
        ...
        dataConfidence: UsageDataConfidence = .unknown)
    {
        ...
        self.clinePassUsage = clinePassUsage
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.clinePassUsage = try container.decodeIfPresent(ClinePassUsageSnapshot.self, forKey: .clinePassUsage)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.clinePassUsage, forKey: .clinePassUsage)
        ...
        dataConfidence: Replacement<UsageDataConfidence> = .unchanged) -> UsageSnapshot
    {
        UsageSnapshot(
            ...
            clinePassUsage: self.clinePassUsage,
