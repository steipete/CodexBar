...
- Cost history: honor timeout cooldowns without a cached snapshot and back off repeated Cursor HTTP 403 cost failures while preserving quota refreshes and manual recovery (#3918, fixes #3910). Thanks @harjothkhara and @Sogl!
