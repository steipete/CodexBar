...
- Claude/Codex: avoid background Keychain prompts during OAuth refresh, OpenAI web cookie imports, and keychain cache reads; refresh cached credentials after file/keychain changes.
