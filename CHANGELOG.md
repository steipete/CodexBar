...
### Fixed
- Provider plugins: run each QuickJS context on a dedicated 4 MiB-stack thread so deep JavaScript recursion raises a clean stack-overflow error instead of overrunning a dispatch worker's native stack.
