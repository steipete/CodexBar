...
### Fixed
- Overview: keep provider cards readable while highlighted on macOS 15 by sharing the existing SwiftUI selection path, while retaining submenu-backed row clicks and drag cancellation (#3173).
