...
- Codex: add GPT-5.6 Sol, Terra, and Luna pricing (including long-context, Priority, cache-write rates, and the `gpt-5.6` Sol alias) so local cost scanning recognizes the new models; bump Pi session cost cache to reprice cached rows.
