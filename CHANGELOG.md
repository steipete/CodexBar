...
- Antigravity: prioritize the most constrained supported quota lane and keep automatic provider rotation fail-open when quota families are incomplete. Thanks @Yuxin-Qiao!
