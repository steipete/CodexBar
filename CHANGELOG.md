...
- Dashboard: project live plugin spend history (OpenRouter Activity) onto the same cost field Codex and Claude already use, instead of leaving usage and spend out of sync. Overview and widgets reuse that live snapshot too, and OpenRouter is selectable in widgets (#3748). Thanks @Chipagosfinest!
