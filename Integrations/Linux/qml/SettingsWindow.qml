...
ApplicationWindow {
    ...
    function load() {
        ...
        scopedCaps.checked = s.showScopedCaps; barProviders.value = s.barProviders;
                ...
                GroupBox {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            // Not editable: "All" is not a number, so typed text would need a parser that
                            // handles both it and localized digits. The arrows cover 0 to 80.
                            SpinBox {
            ...
            Button {
                ...
                onClicked: {
                    if (desktop.saveSettings({provider: provider.editText.trim(), source: source.currentText,
                        ...
                        followOmarchyTheme: theme.checked, showPace: pace.checked, showScopedCaps: scopedCaps.checked, barProviders: barProviders.value,
