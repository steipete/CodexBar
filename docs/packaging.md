...
- `Scripts/pull_build_install_and_run.sh`: runs `git pull --ff-only` and invokes `build_install_and_run.sh` only when the checked-out commit changed.
