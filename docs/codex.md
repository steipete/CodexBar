...
- Explicitly accelerated usage catch-up gives each scanner pass its 10-second budget, matching Usage & Spend; automatic passes remain bounded to two seconds. Forced refreshes used by menu opening and stale-result retries retain the automatic policy.
