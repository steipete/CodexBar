---
summary: "Provider data sources and parsing overview (Codex, Claude, Gemini, Antigravity, Cursor, Droid/Factory, z.ai, Copilot, Kimi, Kimi K2, Kiro, Vertex AI, Augment, Amp, JetBrains AI, Windsurf, GitHub Copilot)."
read_when:
...
| Windsurf | Firebase token extraction (`api`). |
