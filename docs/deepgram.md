...
You can also configure the API key and project ID in CodexBar Settings → Providers → Deepgram.
...
* **DEEPGRAM_PROJECT_ID**': Your Deepgram project UUID. Required.
