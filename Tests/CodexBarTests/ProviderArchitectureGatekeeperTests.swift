...
struct ProviderArchitectureGatekeeperTests {
    ...
    func `small provider capabilities preserve legacy registries`() {
        ...
        #expect(Set(descriptors.filter(\.tokenCost.supportsTokenSnapshot).map(\.id)) == [
            .codex, .claude, .cursor, .vertexai, .bedrock, .kimi, .moonshot,
        ])
        #else
        #expect(Set(descriptors.filter(\.tokenCost.supportsTokenSnapshot).map(\.id)) == [
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["cursor@0", "zed@0"],
            reason: "Provider-specific by design: cross-provider dispatch in shared code."),
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude", "gemini"],
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["gemini@0", "claude@3"],
            reason: "Provider-specific by design: cross-provider dispatch in shared code."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/Providers/Antigravity/AntigravityStatusProbe.swift",
            line: 303,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["codex@0", "codex@5", "codex@17"],
            reason: "Provider-specific by design: cross-provider dispatch in shared code."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/CostUsageFetcher.swift",
            line: 670,
            anchor: "guard provider == .codex || provider == .claude || modelsDevRefreshProviderID(for: provider) != nil",
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 4,
            expectedReferenceFingerprint: ["claude@0", "codex@0", "codex@7", "claude@12"],
            reason: "Provider-specific by design: cross-provider dispatch in shared code."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/CostUsageFetcher.swift",
            line: 1526,
            anchor: "let shouldMergePiUsage = provider != .codex || scopedCodexHomePath?.isEmpty != false",
            expectedProviderIDs: ["claude", "codex", "kimi", "moonshot", "openai"],
            expectedReferenceCount: 10,
            expectedReferenceFingerprint: [
                "codex@0",
                "claude@2",
        ...
        AllowedProviderConstruct(
            ...
            line: 932,
            anchor: ".codex",
            expectedProviderIDs: ["claude", "codex", "kimi", "moonshot"],
            expectedReferenceCount: 10,
            expectedReferenceFingerprint: [
                "codex@0",
                "claude@2",
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["deepseek@0", "openai@3", "opencode@4"],
            reason: "Provider-specific by design: cross-provider dispatch in shared code."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/Vendored/CostUsage/CostUsagePricing.swift",
            line: 861,
            anchor: "case .codex, .openai, .azureopenai:",
            expectedProviderIDs: ["azureopenai", "claude", "codex", "kimi", "moonshot", "openai"],
            expectedReferenceCount: 7,
            expectedReferenceFingerprint: [
                "azureopenai@0",
                "codex@0",
