...
struct ProviderArchitectureGatekeeperTests {
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["alibabatokenplan", "amp", "crof", "cursor", "doubao", "factory", "grok", "ollama", "sub2api"],
        ...
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+WidgetSnapshot.swift",
            line: 460,
            anchor: "if provider == .ollama,",
            expectedProviderIDs: ["alibabatokenplan", "amp", "ollama"],
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["ollama@0", "amp@7", "alibabatokenplan@9"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+WidgetSnapshot.swift",
            line: 493,
