...
struct ProviderArchitectureGatekeeperTests {
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            line: 20,
            anchor: "let openRouterActivityUsage = provider == .openrouter",
            expectedProviderIDs: ["openrouter"],
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["openrouter@0"],
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["codex", "deepseek", "openrouter"],
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["deepseek", "openrouter"],
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["deepseek@0", "openrouter@4"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenAccounts.swift",
            line: 1471,
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["openrouter@0"],
            reason: "This exact app-runtime bridge preserves current-scope optional provider history."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenCost.swift",
            line: 228,
        ...
        AllowedProviderConstruct(
            ...
            line: 435,
            anchor: "case .openai:",
            expectedProviderIDs: ["mistral", "openai", "openrouter", "opencodego"],
            expectedReferenceCount: 4,
            expectedReferenceFingerprint: ["openai@0", "openrouter@2", "mistral@4", "opencodego@6"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenCost.swift",
            line: 456,
            anchor: "case .mistral, .openai, .openrouter, .opencodego:",
            expectedProviderIDs: ["mistral", "openai", "openrouter", "opencodego"],
            expectedReferenceCount: 4,
            expectedReferenceFingerprint: ["mistral@0", "openai@0", "opencodego@0", "openrouter@0"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenCost.swift",
            line: 498,
