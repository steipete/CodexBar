...
struct LocalizationLanguageCatalogTests {
    ...
    func `italian localization matches English catalog and includes current UI labels`() throws {
        ...
        let intentionallyUnchanged: Set = [
            ...
            "GitHub",
            "Google OAuth",
            "Model names are grouped after trimming and case-insensitive exact matching. "
                + "Sources are not deduplicated across providers.",
            "No",
            "No priced model history",
            "Oasis-Token",
            "Other",
            "Partial model history: incomplete source-days are excluded.",
            "Password",
            "Priced model spend",
            "Provider",
            "Show all %d models",
